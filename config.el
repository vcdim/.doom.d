...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Sarasa Mono SC" :foundry "nil" :slant normal :weight normal :height 160 :width normal)))))
